...
export const metadata: Metadata = {
  ...
  description: "Experience the finest handcrafted coffee in a warm, inviting atmosphere. Visit our coffee shop for ethically sourced beans and perfect espresso.",
  keywords: "coffee shop, espresso, latte, cold brew, artisan coffee, local cafe",
  ...
  openGraph: {
    title: "Brew Haven | Premium Coffee Shop",
    description: "Experience the finest handcrafted coffee in a warm, inviting atmosphere.",
    type: "website",
    siteName: "Brew Haven",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_30ordogEOn7VO6LZdIWb5atLXky/uploaded-1765894426028-6z4xflrg.jpg",
  ...
  twitter: {
    ...
    title: "Brew Haven | Premium Coffee Shop",
    description: "Experience the finest handcrafted coffee",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_30ordogEOn7VO6LZdIWb5atLXky/uploaded-1765894426028-6z4xflrg.jpg"]
  },
  robots: {
    index: true,
    follow: true
